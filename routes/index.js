...
exports.index = function(req, res){
  ...
  res.render('index', { 
    ...
    inputSearchNote: translater(lang, {'en':'Please type some keywords.', "zh_TW":'輸入一些關鍵字，如毒蛇,鼬獾等。'}),
    searchingtext: translater(lang, {'en':'Question & Answering', "zh_TW":'輸入問題關鍵字'}),
    inputpos: translater(lang, {'en':'Input Address Positioning', "zh_TW":'輸入位置定位'}),
    selfpos: translater(lang, {'en':'Current Positioning', "zh_TW":'目前位置定位'}),
    ...
    r1: translater(lang, {'en':'1 KM', "zh_TW":'1 公里'}),
    r2: translater(lang, {'en':'2 KM', "zh_TW":'2 公里'}),
    asksnakebite: translater(lang, {'en':'Snake Bites', "zh_TW":'毒蛇 咬傷'}),
    ...
    reportType: translater(lang, {'en':"Animal Type", "zh_TW":'通報類型'}),
    reportTypeDesc: translater(lang, {'en':"Animal Type, Snake?", "zh_TW":'通報類型，眼鏡蛇?鼬獾?'}),
    ...
    sourcecode: translater(lang, {'en':'GIS Source Code', "zh_TW":'GIS 開放原始碼'}),
    scaisourcecode: translater(lang, {'en':'AISource Code', "zh_TW":'AI 開放原始碼'}),
