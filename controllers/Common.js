...
exports.getDictionaryLength = function(getDictObj) {
	var dictLength = 0;
...
exports.getDictionaryKeyList = function(getDictObj) {
	var keyList = [];
	for(var key in getDictObj) {
		keyList.push(key);
	}
...
exports.getDictionaryValueList = function(getDictObj) {
	var valueList = [];
	for(var key in getDictObj) {
...
exports.dictBubbleSortOnValue = function(getDictObj) {
...
*/
exports.getKeyBySortOnValue = function(getDictObj, sortType, getOrder, getListCount) {
	var retKeyList = getDictionaryKeyList(getDictObj);
	switch(sortType) {
		default:
		case "bubble":
 ...
 */
exports.allItemIndexinList = function(getList, getItem) {
	var retList = [];
	var count = 0;
 ...
 */
exports.uniqueList = function(getList) {
	var retList = [];
 ...
 * retn : a number
 */
exports.byteCount = function(getStr) {
